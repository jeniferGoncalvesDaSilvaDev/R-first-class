...
######@> Verificando os dados perdidos...mapa total de missing data
plot_missing(dados)
...
####@> visualizando...
dados$MO
#media de materia organica
mean(dados$MO,na.rm=TRUE)
####@> imputando...
dados$MO.imp <- na_mean(dados$MO)
...
hist(dados$Grosso)
#media de materia organica
mean(dados$Grosso,na.rm=TRUE)
####@> imputando...
dados$Grosso.imp <- na_mean(dados$Grosso)
...
hist(dados$Fino)
#media de materia organica
mean(dados$Fino,na.rm=TRUE)
####@> imputando...
dados$Fino.imp <- na_mean(dados$Fino)
...
hist(dados$Cd)
#media de materia organica
mean(dados$Cd,na.rm=TRUE)
####@> imputando...
dados$Cd.imp <- na_mean(dados$Cd)
